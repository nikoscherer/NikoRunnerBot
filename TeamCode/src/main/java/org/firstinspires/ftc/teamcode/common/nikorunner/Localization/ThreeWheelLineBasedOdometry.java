...
public class ThreeWheelLineBasedOdometry {
...
//    public static double ticksPerIn = 0;
    ...
    private static int[] lastOdoPositions = {0, 0, 0};

    private Pose2d deltaPose = new Pose2d(0, 0, 0);

    public double distancePerTick = 0;

    public ThreeWheelLineBasedOdometry(double distancePerTick) {
